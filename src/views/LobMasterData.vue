          ...
          <div class="modal-body">
            <form @submit.prevent>
              <div class="form-group mb-3">
                ...
                <input type="text" v-model="lob" class="form-control" id="lob" placeholder="Enter Data" required />
              </div>
              <!-- Submit Button -->
...
export default {
  ...
  methods: {
    create() {
      ...
      axios
        .post(
          "http://localhost/TestingProduct/public/api/lob",
          {
            lob: this.lob,
          },
          {
        ...
        .then(function (response) {
          ...
          localStorage.setItem("lob", response.data.data.lob);

          ...
          <div class="modal-body">
            <form @submit.prevent>
              <div class="form-group mb-3">
                <label for="dept" class="form-label-bold">Dept</label>
                <input type="text" v-model="dept" class="form-control" id="dept" placeholder="Enter Data" required />
              </div>
              <!-- Submit Button -->
...
export default {
  ...
  methods: {
    create() {
      ...
      axios
        .post(
          "http://localhost/TestingProduct/public/api/dept",
          {
            dept: this.dept,
          },
          {

          ...
          <div class="modal-body">
            <form @submit.prevent>
              <div class="form-group mb-3">
                <label for="apps" class="form-label-bold">Apps</label>
                <input type="text" v-model="apps" class="form-control" id="apps" placeholder="Enter Data" required />
              </div>
              <!-- Submit Button -->
...
export default {
  ...
  methods: {
    create() {
      ...
      axios
        .post(
          "http://localhost/TestingProduct/public/api/apps",
          {
            apps: this.apps,
          },
          {

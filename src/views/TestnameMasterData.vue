<template>
          ...
          <div class="modal-body">
            <form @submit.prevent>
              <div class="form-group mb-3">
                <label for="test_name" class="form-label-bold">Testname</label>
                <input type="text" v-model="test_name" class="form-control" id="test_name" placeholder="Enter Data" required />
              </div>
              <!-- Submit Button -->
  ...
  <div class="container mt-4">
    <h4>testname Master Data List</h4>
...
export default {
  ...
  methods: {
    create() {
      ...
      axios
        .post(
          "http://localhost/TestingProduct/public/api/testname",
          {
            test_name: this.test_name,
          },
          {
        ...
        .then(function (response) {
          ...
          localStorage.setItem("test_name", response.data.data.test_name);
